...
import { useBlogQuery } from "@/features/blog/hooks";
import { cn } from "@/lib/utils";

const DEBOUNCE_MS = 400;

/**
 * Debounced blog search wired to ?search=
 */
export default function BlogSearch({ placeholder, className }) {
  const { params, update } = useBlogQuery();
