...
export const endpoints = {
  products: {
    ...
    compare: "/public/products/compare",
    customerCompare: "/customer/products/compare",
  },
  ...
  /** @deprecated Prefer `products.compare` / `products.customerCompare`. */
  compare: {
    public: "/public/products/compare",
    customer: "/customer/products/compare",
  },
  orders: {
