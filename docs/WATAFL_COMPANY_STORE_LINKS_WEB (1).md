...
- [ ] Route ديناميكي من `tax_number`
- [ ] `GET /api/public/store/{tax}`
- [ ] UI للهوية: logo + حتى 3 صور + about
- [ ] محاولة `deep_link` فور التحميل
- [ ] بعد ~1.5s + الصفحة ظاهرة → CTA لـ `play_store_url`
- [ ] حالة 404 واضحة
- [ ] SEO/OG اختياري (اسم الشركة + صورة)
